...
import com.starlead.starleadhprecision.util.ErrorInfo;
import com.starlead.starleadhprecision.util.TTSController;
...
public class NaviBaseActivity extends Activity implements AMapNaviListener, AMapNaviViewListener {
    ...
    protected NaviLatLng mStartLatlng = new NaviLatLng(32.119293,118.903869);
    protected NaviLatLng mEndLatlng = new NaviLatLng(32.114041,118.908589);
