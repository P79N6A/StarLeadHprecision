...
import com.starlead.starleadhprecision.util.Base64Utils;
import com.starlead.starleadhprecision.util.SharedPreferencesUtils;
...
//       return password;   //解码一下
    ...
    private void login() {
      ...
      if (getAccount().isEmpty()){
        ...
        final String url = "http://192.168.1.102:8080/Login?method=LoginCheck&username=" + getAccount() + "&password=" + getPassword();
            ...
            public void run() {
                ...
                try {
                    ...
                    if ("1".equals(jsonObject.get("status"))) {
                        ...
                        startActivity(new Intent(LoginActivity.this, PatrolSchemeActivity.class));
                        finish();//关闭页面
                    } else {
